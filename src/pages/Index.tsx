...
const Index: React.FC = () => {
  ...
  const handleFinishedLoading = () => setLoading(false);
      ...
      <div className={`transition-opacity duration-1000 ${loading ? 'opacity-0' : 'opacity-100'}`}>
        ...
        <section className="h-screen relative overflow-hidden">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
            <h1
              className="text-4xl md:text-6xl lg:text-7xl font-serif mb-4 animate-fade-in"
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {stats.map((stat, i) => (
                <RevealSection key={i} delay={i * 150} className="text-center">
                  <div className="text-3xl md:text-4xl font-serif bg-clip-text text-transparent bg-gold-gradient mb-1">
                    {stat.number}
                  </div>
        ...
        <section className="section-padding bg-secondary/20">
          <div className="container mx-auto">
            <RevealSection className="text-center mb-16">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Every project tells a unique story. Explore our collection of thoughtfully designed spaces.
              </p>
            </RevealSection>
                  ...
                  {testimonials.map((_, i) => (
                    <button
                      ...
                      className={`w-2.5 h-2.5 rounded-full transition-all duration-300 ${
                        activeTestimonial === i ? 'bg-accent w-8' : 'bg-accent/30'
                      }`}
                    />
                  ))}
                </div>
        ...
        <section className="py-24 px-6 relative overflow-hidden">
          ...
          <RevealSection className="relative z-10 text-center max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground mb-8 text-lg">
              Book a free consultation and let's bring your dream space to life. No commitment, just great ideas.
            </p>
